! function (e, o) {
    ...
    var a = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
        ...
        s = function (e, o, t, n) {
            ...
            t && (i.expires = new Date, i.expires.setTime(i.expires.getTime() + 60 * t * 1e3)), n && (i.domain = n), document.cookie = r(e, encodeURIComponent(o), i)
        },
        u = function (e) {
    ...
    var y = function () {
        ...
        return t = o, (n = [{
            ...
            value: function (e) {
                ...
                }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = t, this.addDetector(l), this.addDetector(c), this.addDetector(f), this.addDetector(m), this.addDetector(v), this.addDetector(k), this.addDetector(w), this.addDetector(S)
            }
        }, {
            key: "addDetector",
            value: function (e) {
