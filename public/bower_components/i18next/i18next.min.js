        ...
        C = function (t) {
            ...
            return c(i, f), r(i, [{
                ...
                value: function (t, o, r) {
                    ...
                    var s = void 0 !== o.keySeparator ? o.keySeparator : this.options.keySeparator,
                    ...
                    var d = this.resolve(t, o),
                        ...
                        k = void 0 !== o.joinArrays ? o.joinArrays : this.options.joinArrays,
                    ...
                    if (x && v && ("string" != typeof v && "boolean" != typeof v && "number" != typeof v) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(b) < 0 && ("string" != typeof k || "[object Array]" !== b)) {
                        if (!o.returnObjects && !this.options.returnObjects) return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(y, v, o) : "key '".concat(l, " (").concat(this.language, ")' returned an object instead of string.");
                        if (s) {
                            ...
                            for (var O in v)
                                if (Object.prototype.hasOwnProperty.call(v, O)) {
                                    var R = "".concat(L).concat(s).concat(O);
                                    S[O] = this.translate(R, n({}, o, {
                                        joinArrays: !1,
                                        ns: c
                                    })), S[O] === R && (S[O] = v[O])
                                } v = S
                        }
                    } else if (x && "string" == typeof k && "[object Array]" === b) (v = v.join(k)) && (v = this.extendTranslation(v, t, o, r));
                    else {
                        var C = !1,
                            N = !1,
                            j = void 0 !== o.count && "string" != typeof o.count,
                            E = i.hasDefaultValue(o),
                            P = j ? this.pluralResolver.getSuffix(g, o.count) : "",
                            F = o["defaultValue".concat(P)] || o.defaultValue;
                        !this.isValidLookup(v) && E && (C = !0, v = F), this.isValidLookup(v) || (N = !0, v = l);
                        var V = E && F !== v && this.options.updateMissing;
                        if (N || C || V) {
                            if (this.logger.log(V ? "updateKey" : "missingKey", g, p, l, V ? F : v), s) {
                                var T = this.resolve(l, n({}, o, {
                                    keySeparator: !1
                                }));
                            ...
                            else "all" === this.options.saveMissingTo ? A = this.languageUtils.toResolveHierarchy(o.lng || this.language) : A.push(o.lng || this.language);
                            var I = function (e, t, n) {
                                a.options.missingKeyHandler ? a.options.missingKeyHandler(e, p, t, V ? n : v, V, o) : a.backendConnector && a.backendConnector.saveMissing && a.backendConnector.saveMissing(e, p, t, V ? n : v, V, o), a.emit("missingKey", e, p, t, v)
                            };
                            this.options.saveMissing && (this.options.saveMissingPlurals && j ? A.forEach(function (e) {
                                a.pluralResolver.getSuffixes(e).forEach(function (t) {
                                    I([e], l + t, o["defaultValue".concat(t)] || F)
                                })
                            }) : I(A, l, F))
                        }
                        v = this.extendTranslation(v, t, o, d, r), N && v === l && this.options.appendNamespaceToMissingKey && (v = "".concat(p, ":").concat(l)), N && this.options.parseMissingKeyHandler && (v = this.options.parseMissingKeyHandler(v))
                    }
                    return v
                }
            }, {
        ...
        return c(i, f), r(i, [{
            ...
            value: function () {
                ...
                var l = h(),
                    c = function () {
                        var e = function (e, n) {
                            t.isInitialized && t.logger.warn("init: i18next is already initialized. You should call init just once!"), t.isInitialized = !0, t.options.isClone || t.logger.log("initialized", t.options), t.emit("initialized", t.options), l.resolve(n), i(e, n)
                        };
                        if (t.languages && "v1" !== t.options.compatibilityAPI) return e(null, t.t.bind(t));
